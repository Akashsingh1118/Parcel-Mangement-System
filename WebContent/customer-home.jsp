...
<head>
    ...
    <meta name="description" content="Customer Home - Parcel Management System">
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #CADCFC; /* Grey background */
        }
        .header {
...
<body>
    <div class="header">
        ...
        <div class="menu">
            ...
            <a href="booking-customer.jsp">Booking Service</a>
            <a href="tracking-status.jsp">Tracking</a>
            <a href="bookingHistory.jsp">Previous Booking</a>
